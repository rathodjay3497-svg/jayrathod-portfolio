...
export const PERSONAL = {
  ...
  taglines: [
    "AI Engineer | RAG | LLMs | Vector Databases",
...
export const EXPERIENCES: Experience[] = [
  ...
  },
  {
    ...
    role: "Consultant / Master Trainer",
    ...
    description: [
      ...
      "Trained 10,000+ students and 500+ faculty members in Machine Learning, Deep Learning, and AI across academic and enterprise environments.",
    ],
  },
  {
    id: "measureone",
    ...
    description: [
      ...
      "Reduced API response times by 10% through query optimization, caching, and efficient request handling.",
  ...
  },
  {
    ...
    description: [
      ...
      "Implemented rigorous testing strategies for ML models, ensuring accuracy, bias reduction, and performance improvements.",
    ],
  },
  {
    id: "toshiba",
